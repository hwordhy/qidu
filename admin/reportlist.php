...
include_once jieqi_path_inc("class/report.php", "system");
$report_handler = JieqiReportHandler::getInstance("JieqiReportHandler");
if (isset($_POST["act"]) && ($_POST["act"] == "delete") && is_array($_REQUEST["checkid"]) && (0 < jieqi_count($_REQUEST["checkid"]))) {
	jieqi_checkpost();
	$where = "";
...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("admin/reportlist.html", "system");
