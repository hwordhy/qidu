...
include_once jieqi_path_inc("class/vips.php", "system");
...
case "edit":
	if (!empty($_REQUEST["id"])) {
		...
		if (is_object($vips)) {
			...
			$vips_form->addElement(new JieqiFormText($jieqiLang["system"]["table_vips_minegold"], "minegold", 30, 250, $vips->getVar("minegold", "e")), true);
			
			$vips_form->addElement(new JieqiFormText($jieqiLang["system"]["table_vips_maxegold"], "maxegold", 30, 250, $vips->getVar("maxegold", "e")), true);
			
			$vips_form->addElement(new JieqiFormText($jieqiLang["system"]["table_vips_viptype"], "viptype", 30, 250, $vips->getVar("viptype", "e")), true);
			
			$vips_form->addElement(new JieqiFormText($jieqiLang["system"]["table_vips_extraegold"], "extraegold", 30, 250, $vips->getVar("extraegold", "e")), true);
			
			$vips_form->addElement(new JieqiFormText($jieqiLang["system"]["table_vips_extradiv"], "extradiv", 30, 250, $vips->getVar("extradiv", "e")), true);
...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("admin/vips.html", "system");
include_once jieqi_path_common("admin/footer.php");
