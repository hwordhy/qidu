...
$system_users_fields["salt"] = array("name" => "salt", "type" => JIEQI_TYPE_TXTBOX, "value" => "", "caption" => "�������", "required" => false, "maxlength" => 32);
...
$system_users_fields["verify"] = array("name" => "verify", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "����֤��Ϣ", "required" => false, "maxlength" => 11);
$system_users_fields["showset"] = array("name" => "showset", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��ʾ����", "required" => false, "maxlength" => 11);
$system_users_fields["acceptset"] = array("name" => "acceptset", "type" => JIEQI_TYPE_INT, "value" => 1, "caption" => "��������", "required" => false, "maxlength" => 11);
...
$system_users_fields["sumtip"] = array("name" => "sumtip", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��������", "required" => false, "maxlength" => 11);
$system_users_fields["sumtask"] = array("name" => "sumtask", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��������", "required" => false, "maxlength" => 11);
$system_users_fields["sumworks"] = array("name" => "sumworks", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��Ʒ����", "required" => false, "maxlength" => 11);
$system_users_fields["sumaward"] = array("name" => "sumaward", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��������", "required" => false, "maxlength" => 11);
$system_users_fields["sumother"] = array("name" => "sumother", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "��������", "required" => false, "maxlength" => 11);
$system_users_fields["sumemoney"] = array("name" => "sumemoney", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "���������", "required" => false, "maxlength" => 11);
$system_users_fields["summoney"] = array("name" => "summoney", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "�ֽ�����", "required" => false, "maxlength" => 11);
$system_users_fields["paidmoney"] = array("name" => "paidmoney", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "�Ѹ��ֽ�", "required" => false, "maxlength" => 11);
$system_users_fields["paidemoney"] = array("name" => "paidemoney", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "�Ѹ������", "required" => false, "maxlength" => 11);
$system_users_fields["paytime"] = array("name" => "paytime", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "����ʱ��", "required" => false, "maxlength" => 11);
...
$system_users_fields["expenses"] = array("name" => "expenses", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "���Ѷ�", "required" => false, "maxlength" => 11);
$system_users_fields["conisbind"] = array("name" => "conisbind", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "�Ƿ��QQ��¼", "required" => false, "maxlength" => 11);
$system_users_fields["viplevel"] = array("name" => "viplevel", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "���µȼ�", "required" => false, "maxlength" => 11);
...
$system_users_fields["state"] = array("name" => "state", "type" => JIEQI_TYPE_INT, "value" => 0, "caption" => "�û����µȼ�", "required" => false, "maxlength" => 1);
global $system_users_soptions;
