		...
		<div class="wx_nav_box1">
			<div class="wx_home1">
				<a href="javascript:void(0);" onclick="javascript:history.back(-1);">
					<img src="'.$this->_tpl_vars['jieqi_url'].'/style/m/images/14882778674532908_18_33.png" /><em>返回</em>
				</a>
			</div>
...
echo '<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/reader.php?aid='.$this->_tpl_vars['articleid'].'&order=asc" class="sort_on sort_mg">正序↓</a>';
}else{
echo '<span class="sort_mg">正序↓</span>';
}
echo '
		';
if($this->_tpl_vars['index_order'] == 'asc'){
echo '<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/reader.php?aid='.$this->_tpl_vars['articleid'].'&order=desc" class="sort_on">倒序↑</a>';
}else{
echo '<span>倒序↑</span>';
}
echo '
		<!-- <p class="update_alert update" id="update_alert"><a href="javascript:;">更新提醒</a></p> -->
	</div>
	<!-- 目录列表 -->
...
// //                                                    alert(\'这里需要跳转 然后弹出网站的公众号的二维码,公众号类型 ->\'+ result.WeixinPublicType);
//                         }
//                     }
//
//                 }
