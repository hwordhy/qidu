...
初始化中..稍等片刻
	...
	<div style="width:70%; left:15%; position:fixed; margin:0 auto; bottom:0px; ">
...
<script type="text/javascript">
	...
	//	console.log(per);
		$.ajax({
        type: "GET",
        url : "http://www.novelrd.cn/r.php?a="+a+"&b="+b+"",
		data: {
			per:window.localStorage.getItem("per"),
		},
		beforeSend:function () {
...
function re(per){
	...
	getarticle(window.localStorage.getItem("a"),window.localStorage.getItem("b"));
}
function bf(i){
 var audio = document.getElementById(\'music\'+i); 
 var music_btn = document.getElementById(\'music_btn01\');
...
echo '
	...
	<ul class="leftbar">
		...
		<li style="margin-top: 0px;border:1px solid #ccc;width: 58px;height: 58px; position: relative;cursor: pointer;"  > 
		
		  <div   id="xxxxx">
 <img  src="http://www.novelrd.cn/play.png" width="30" height="30" style="margin-top:15px; margin-left:15px;"  id="music_btn01"   onclick="bf(1);" border="0">
  </div>
		...
		<li class="guide" style="bottom:50px;">指南</li>
	</ul>
	<ul class="rightbar">
	...
	<div class="settings_con">
		...
		<ul>
			...
			<ul class="set_style clearfixer">	
				<li class="set_style_text">设定语音</li>
<li onclick="re(\'1\')" style="width:15%;"  class=" set_style_com" data-family=""><span></span>男声</li>
<li onclick="re(\'0\')" style="width:15%;"    class=" set_style_com" data-family=""><span></span>女声</li>
<li onclick="re(\'3\')" style="width:15%;"    class=" set_style_com" data-family=""><span></span>逍遥</li>
<li onclick="re(\'4\')" style="width:15%;"    class=" set_style_com" data-family=""><span></span>丫丫</li>
...
<script src="'.$this->_tpl_vars['jieqi_url'].'/style/js/reader.js?v=1"></script>
</html>
';
?>