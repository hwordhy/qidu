...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
    <li>
        <a data-control-type="shelf" target="_blank" href="'.jieqi_geturl('news','info',$this->_tpl_vars['newsrows'][$this->_tpl_vars['i']['key']]['topicid']).'">'.$this->_tpl_vars['newsrows'][$this->_tpl_vars['i']['key']]['title'].'</a>
    </li>
';
}
