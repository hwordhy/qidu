...
echo '
    ...
    <div class="headerbg ibody" style="margin-bottom:10px;">
        ...
        <div class="wrap1200 logo iMod">
            <a href="'.$this->_tpl_vars['jieqi_url'].'/userdetail.php" class="fl imotie">个人中心</a>
            <ul class="iUl">
                <li><a href="'.$this->_tpl_vars['jieqi_url'].'/">首页</a></li>
                <li class="accounts">
                    <a href="javaScript:;">账户设置</a>
                    <p>
                        <a href="'.$this->_tpl_vars['jieqi_url'].'/useredit.php">个人信息</a>
                        <a href="'.$this->_tpl_vars['jieqi_url'].'/passedit.php">修改密码</a>
                    </p>
                </li>
                <!--<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/authorpage.php?id='.$this->_tpl_vars['jieqi_userid'].'">个人主页</a></li>-->
                <li><a href="'.$this->_tpl_vars['jieqi_url'].'/message.php?box=inbox">消息</a><cite  id="bubble" class="bubbleNum">'.$this->_tpl_vars['jieqi_newmessage'].'</cite></li>
            ...
            <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/bookcase.php" class="mybookshelf fr"><i  style="background-color:#333333"></i>我的书架</a>
        </div>
        <!--搜索部分 end-->
        <!--导航 start-->
    </div>
...
<div class="container wrap1200">
    ...
    <div class="i-left">
        ...
        <ul>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/useredit.php"><span class="basicInfo"></span>个人信息</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/setavatar.php"><span class="pictureInfo"></span>修改头像</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/userbind.php"><span class="basicInfo"></span>账号绑定</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/passedit.php"><span class="pictureInfo"></span>修改密码</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/persondetail.php"><span class="basicInfo"></span>联系信息</a></li>
        </ul>
        <!--关注中心 mod -->
        <p class="title"><span></span>关注中心</p>
        <ul>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/bookcase.php"><span></span>我的书架</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/bookshelf.php"><span class="readed"></span>最近阅读</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/myreviews.php"><span class="bookreview"></span>我的评论</a></li>
        </ul>
        <!--资产中心 mod -->
        <p class="title"><span class="zc"></span>资产中心</p>
        <ul>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['pay']['url'].'/paylog.php" data-namecard="false"><span class="money"></span>充值记录</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/myactlog.php" data-namecard="false"><span class="package"></span>我的消费</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/myactlog.php?act=poll" data-namecard="false"><span class="ticket"></span>我的推荐票</a></li>
        </ul>
        <p class="title"><span class="msg"></span>消息</p>
        <ul class="msgTab">
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/message.php?box=inbox"><span class="system"></span>收件箱</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/message.php?box=outbox"><span class="remind"></span>发件箱</a></li>
            <li><a href="'.$this->_tpl_vars['jieqi_url'].'/newmessage.php"><span class="reply"></span>发送消息</a></li>
        </ul>
        <!--&lt;!&ndash;论坛 mod &ndash;&gt;-->
        <!--<p class="title"><span class="authorManage"></span>论坛</p>-->
        <!--<ul>-->
            <!--<li><a href="'.$this->_tpl_vars['jieqi_modules']['forum']['url'].'/mytopics.php"><span class="my_forum"></span>我的帖子</a></li>-->
        <!--</ul>-->
    </div>
