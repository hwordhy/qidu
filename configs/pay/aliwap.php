...
$jieqiPayset['aliwap']['payid'] = '2088531471053274';  //签约的支付宝账号唯一用户号（PID），以2088开头的16位纯数字组成（请输入实际申请的值）

$jieqiPayset['aliwap']['paykey'] = 'l0dxmoprfysk88djwjsii4uz381gkpbv';  //通讯密钥值（KEY）（请输入实际申请的值）
...
$jieqiPayset['aliwap']['paycustom'] = 1; //是否允许自定义购买金额，0-不允许，1-允许
$jieqiPayset['aliwap']['paylimit'] = array('3000'=>'30', '5000'=>'5000', '10000'=>'100', '20000'=>'200', '50000'=>'500', '100000'=>'1000'); //允许选择的 虚拟币=>金额 选项，如 '1000'=>'10' 是指购买 1000虚拟币需要10元
$jieqiPayset['aliwap']['paydefault'] = '3000'; //默认充值虚拟币
...
$jieqiPayset['aliwap']['seller_email'] = 'cmqxwx@foxmail.com';  //卖家邮箱，必须填写
