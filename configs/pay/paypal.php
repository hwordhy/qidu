...
$jieqiPayset['paypal']['payid'] = 'email';  //收款账号(默认email账号)

$jieqiPayset['paypal']['paykey'] = '';  //密钥值(默认不需要)
...
$jieqiPayset['paypal']['paydefault'] = '1000'; //默认充值虚拟币
...
$jieqiPayset['paypal']['item_name'] = JIEQI_EGOLD_NAME;  //商品名 英文数字 JIEQI_EGOLD_NAME

$jieqiPayset['paypal']['charset'] = JIEQI_SYSTEM_CHARSET;  //编码 针对有中文内容

$jieqiPayset['paypal']['currency_code'] = 'USD';  //货币类型 USD-美元  HKD-港币 TWD-新台币 

$jieqiPayset['paypal']['rm'] = '1'; //支付成功返回时候是否返回提交过去的参数（GET方式）1-返回参数 0-不返回

$jieqiPayset['paypal']['cancel_return'] = JIEQI_LOCAL_URL.'/modules/pay/buyegold.php?t=paypalpay';  //取消购买返回地址
