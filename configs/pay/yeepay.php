...
$jieqiPayset['yeepay']['payid'] = '000000';  //合作伙伴ID（请输入实际申请的值）

$jieqiPayset['yeepay']['paykey'] = '000000';  //通讯密钥值（请输入实际申请的值）
...
$jieqiPayset['yeepay']['paydefault'] = '1000'; //默认充值虚拟币
...
$jieqiPayset['yeepay']['frpId'] = 'ICBC-NET-B2C';  //支付通道，默认工行
