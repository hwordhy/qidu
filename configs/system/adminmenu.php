...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '电脑版系统定义', 'command'=>JIEQI_URL.'/admin/configs.php?mod=system&define=1&pubdir=www', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '手机版系统定义', 'command'=>JIEQI_URL.'/admin/configs.php?mod=system&define=1&pubdir=m', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '动作配置', 'command'=>JIEQI_URL.'/admin/actionfiles.php', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '电脑版区块配置', 'command'=>JIEQI_URL.'/admin/blockfiles.php?pubdir=www', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '手机版区块配置', 'command'=>JIEQI_URL.'/admin/blockfiles.php?pubdir=m', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => '充值月报表', 'command'=>$GLOBALS['jieqiModules']['pay']['url'].'/admin/mreport.php', 'target' => 0, 'publish' => 1);
