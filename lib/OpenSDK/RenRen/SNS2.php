...
class OpenSDK_RenRen_SNS2 extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "https://graph.renren.com/oauth/token";
	static 	private $authorizeURL = "https://graph.renren.com/oauth/authorize";
	static 	private $sessinKeyURL = "https://graph.renren.com/renren_api/session_key";
	/**
     * OAuth 版本
     * @var string
     */
	...
	static public function getAuthorizeURL($url, $response_type, $state, $display = "default")
	{
		$params = array();
