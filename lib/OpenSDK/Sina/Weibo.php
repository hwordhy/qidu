...
class OpenSDK_Sina_Weibo extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "http://api.t.sina.com.cn/oauth/access_token";
	static 	private $authorizeURL = "http://api.t.sina.com.cn/oauth/authorize";
	static 	private $requestTokenURL = "http://api.t.sina.com.cn/oauth/request_token";
	/**
     * OAuth 版本
     * @var string
     */
	static 	protected $version = "1.0a";
