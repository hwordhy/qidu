...
class OpenSDK_Sohu_Weibo extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "http://api.t.sohu.com/oauth/access_token";
	static 	private $authorizeURL = "http://api.t.sohu.com/oauth/authorize";
	static 	private $requestTokenURL = "http://api.t.sohu.com/oauth/request_token";
