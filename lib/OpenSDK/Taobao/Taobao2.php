...
class OpenSDK_Taobao_Oauth2 extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "https://oauth.taobao.com/token";
	static 	private $authorizeURL = "https://oauth.taobao.com/authorize";
	/**
     * OAuth 版本
     * @var string
     */
	...
	static public function getAuthorizeURL($url, $response_type, $state, $view = "web")
	{
		$params = array();
