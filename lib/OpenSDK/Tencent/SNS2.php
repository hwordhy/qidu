...
class OpenSDK_Tencent_SNS2 extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "https://graph.qq.com/oauth2.0/token";
	static 	private $authorizeURL = "https://graph.qq.com/oauth2.0/authorize";
	static 	private $openidURL = "https://graph.qq.com/oauth2.0/me";
	/**
     * OAuth 版本
     * @var string
     */
	...
	static public function getAuthorizeURL($url, $response_type, $state, $ismobile = 0, $scope = "")
	{
		$params = array();
