...
class OpenSDK_Tencent_Weibo extends OpenSDK_OAuth_Interface
{
	...
	static 	private $accessTokenURL = "http://open.t.qq.com/cgi-bin/access_token";
	static 	private $authorizeURL = "http://open.t.qq.com/cgi-bin/authorize";
	static 	private $requestTokenURL = "http://open.t.qq.com/cgi-bin/request_token";
	/**
     * OAuth 对象
	...
	static public function getAuthorizeURL($token, $mini = false)
	{
		if (is_array($token)) {
