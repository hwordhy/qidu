...
class JieqiFTP extends JieqiObject
{
	...
	static public function close($ftp = NULL)
	{
		if (is_object($ftp)) {
			$ftp->ftp_close();
		}
	...
	static public function getInstance($ftphost = "", $ftpuser = "", $ftppass = "", $ftppath = ".", $ftpport = 21, $timeout = 0, $ftpssl = 0, $ftppasv = 1)
	{
