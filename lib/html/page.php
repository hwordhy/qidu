	...
	public function whole_bar()
	{
		...
		case 2:
			...
			elseif(JIEQI_COVER_DIR == '') {
                $html_template = "<ul><li><a>{?\$jieqi_page_current?}/{?\$jieqi_page_totalpages?}</a></li><li><a href=\"{?\$jieqi_page_previousurl?}\">{?\$jieqi_page_previouslang?}</a></li><li><a href=\"{?\$jieqi_page_nexturl?}\">{?\$jieqi_page_nextlang?}</a></li></ul><div class=\"pageform\" id=\"pageForm\"><span>飞到</span><input type=\"text\" name=\"" . $this->pagevar . "\" id=\"pageNum\" class=\"pageNum\" value=\"1\" onkeydown=\"if(event.keyCode==13){{?\$jieqi_page_jumpjs?} return false;}\"><span>页</span><span class=\"gobtn\" id=\"gobtn\" onclick=\"{?\$jieqi_page_jumpjs?}\">go</span></div>";
            }
            else{
		...
		default:
            ...
            elseif(JIEQI_COVER_DIR == '') {
                $html_template = "<ul>{?\$jieqi_page_firsthtm?}{?\$jieqi_page_previoushtm?}{?\$jieqi_page_numshtm?}{?\$jieqi_page_nexthtm?}{?\$jieqi_page_lasthtm?}</ul><div class=\"pageform\" id=\"pageForm\"><span>飞到</span><input type=\"text\" name=\"" . $this->pagevar . "\" id=\"pageNum\" class=\"pageNum\" value=\"1\" onkeydown=\"if(event.keyCode==13){{?\$jieqi_page_jumpjs?} return false;}\"><span>页</span><span class=\"gobtn\" id=\"gobtn\" onclick=\"{?\$jieqi_page_jumpjs?}\">go</span></div>";
            }
            else{
