...
class JieqiMail extends JieqiObject
{
	...
	public function sendmail()
	{
		...
		if (($this->params['mailtype'] == 1) && function_exists('mail')) {
			...
			else if ((!isset($this->params['mailencrypt']) && ($this->params['mailport'] == 587)) || (isset($this->params['mailencrypt']) && (($this->params['mailencrypt'] == 2) || (strtoupper($this->params['mailencrypt']) == 'TLS')))) {
