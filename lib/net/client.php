...
class JieqiClient extends JieqiObject
{
	...
	{
		if (0 < jieqi_count($this->_responses)) {
			return $this->_responses[jieqi_count($this->_responses) - 1];
		}
		else {
			return false;
		}
	...
	public function _pushResponse(&$request)
	{
		...
		$idx = ($this->_isHistoryEnabled ? jieqi_count($this->_responses) : 0);
