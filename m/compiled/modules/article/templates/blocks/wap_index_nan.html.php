...
<a href="'.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['url_articleinfo'].'" data-recommendid="79376">
    <div class="chl_con_first clearfix">
            ...
            <span class="right fl"><h3>'.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['articlename'].'</h3><h5>зїеп:&nbsp'.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['author'].'</h5>
             <div>
