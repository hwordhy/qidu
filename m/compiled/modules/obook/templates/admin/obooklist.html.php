<?php
echo '<form name="frmsearch" method="get" action="'.$this->_tpl_vars['url_obook'].'">
...
echo '</td>
    ...
    <td align="center"><a href="'.jieqi_geturl('article','article',$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['articleid'],'index').'" target="_blank">目录</a> | <a href="'.$this->_tpl_vars['obook_static_url'].'/admin/txtobook.php?id='.$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['obookid'].'">下载TXT</a></td>
  </tr>
  ';
}
echo '
