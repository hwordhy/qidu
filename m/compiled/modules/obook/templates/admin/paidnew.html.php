...
<tr valign="middle" align="left">
  <td class="tdl" width="25%">电子书名：</td>
  <td class="tdr"><a href="'.$this->_tpl_vars['obook_dynamic_url'].'/obookinfo.php?id='.$this->_tpl_vars['obookid'].'" target="_blank">'.$this->_tpl_vars['obookname'].'</a> (作者：<a href="'.$this->_tpl_vars['jieqi_url'].'/userinfo.php?id='.$this->_tpl_vars['authorid'].'" target="_blank">'.$this->_tpl_vars['author'].'</a>)</td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl">作者真实信息：</td>
  <td class="tdr">
...
<tr valign="middle" align="left">
  <td class="tdl">本书已结算：</td>
  <td class="tdr">'.$this->_tpl_vars['paidemoney'].' '.$this->_tpl_vars['egoldname'].'
  </td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl">本书待结算：</td>
  <td class="tdr">'.$this->_tpl_vars['remainemoney'].' '.$this->_tpl_vars['egoldname'].'
  </td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl">本次结算：</td>
  <td class="tdr">
  <input type="text" class="text" name="payemoney" id="payemoney" size="10" maxlength="10" value="" /> '.$this->_tpl_vars['egoldname'].' <span class="hot">（必须是整数）</span>
  </td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl">支付人民币：</td>
  <td class="tdr">
  <input type="text" class="text" name="paymoney" id="paymoney" size="10" maxlength="10" value="" /> 元 <span class="hot">（如 123.45）</span>
  </td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl">结算类型：</td>
  <td class="tdr">
  ';
