      ...
      xurl2=localStorage.getItem("xurl2");
            ...
            <div class="bookcats">
                ...
                <a  class="active" >最近阅读历史</a>
                 ...
                 <ul class="my_list">
                     <li style="width:100%;text-align:center;"><p>只保留3个哟！更换浏览器就不存在喽！</p></li>
                    <script type="text/javascript">
                        if (xst!==null) {
...
document.writeln("</p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\' href=\\\'\\\' class=\\\'btn-gray\\\' id=\\\'del\\\'>移除</a></p>");
document.writeln("                        </li>");
...
document.writeln("</p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\'  href=\\\'\\\' class=\\\'btn-gray\\\' id=\\\'del1\\\'>移除</a></p>");
document.writeln("                        </li>");
...
document.writeln("</p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\'class=\\\'btn-gray\\\' href=\\\'\\\' id=\\\'del2\\\'>移除</a></p>");
document.writeln("                        </li>");
