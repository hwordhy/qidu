...
document.writeln("</p>");
document.writeln("<p class=\\\'wordhide\\\'><a>最近更新：'.date('\\\m-d H:i\\\',$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['lastupdate']).'</a></p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\' href=\\\'javascript:;\\\' onclick=\\\'act_delete(\\\''.$this->_tpl_vars['jieqi_modules'][\'article\'][\'url\'].'/bookcase.php?bid='.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['caseid'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\\\');\\\' class=\\\'btn-gray\\\' id=\\\'del\\\'>移除书架</a></p>");
document.writeln("                        </li>");
...
document.writeln("</p>");
document.writeln("<p class=\\\'wordhide\\\'><a>最近更新：'.date('\\\m-d H:i\\\',$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['lastupdate']).'</a></p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\' href=\\\'javascript:;\\\' onclick=\\\'act_delete(\\\''.$this->_tpl_vars['jieqi_modules'][\'article\'][\'url\'].'/bookcase.php?bid='.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['caseid'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\\\');\\\' class=\\\'btn-gray\\\' id=\\\'del1\\\'>移除书架</a></p>");
document.writeln("                        </li>");
...
document.writeln("</p>");
document.writeln("<p class=\\\'wordhide\\\'><a>最近更新：'.date('\\\m-d H:i\\\',$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['lastupdate']).'</a></p>");
document.writeln(" <p><a style=\\\'color:#21a7ee\\\' href=\\\'javascript:;\\\' onclick=\\\'act_delete(\\\''.$this->_tpl_vars['jieqi_modules'][\'article\'][\'url\'].'/bookcase.php?bid='.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['caseid'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\\\');\\\' class=\\\'btn-gray\\\' id=\\\'del2\\\'>移除书架</a></p>");
document.writeln("                        </li>");
