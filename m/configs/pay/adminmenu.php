...
$jieqiAdminmenu['pay'][] = array('layer' => 0, 'caption' => '充值卡生成', 'command'=>$GLOBALS['jieqiModules']['pay']['url'].'/modules/pay/admin/makepaycard.php', 'target' => 0, 'publish' => 1);
$jieqiAdminmenu['pay'][] = array('layer' => 0, 'caption' => '充值卡查询', 'command'=>$GLOBALS['jieqiModules']['pay']['url'].'/modules/pay/admin/showpaycard.php', 'target' => 0, 'publish' => 1);
?>