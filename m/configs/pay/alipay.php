...
$jieqiPayset['alipay']['payid'] = '2088531471053274';  //合作伙伴ID（请输入实际申请的值）

$jieqiPayset['alipay']['paykey'] = 'l0dxmoprfysk88djwjsii4uz381gkpbv';  //通讯密钥值（请输入实际申请的值）
...
$jieqiPayset['alipay']['seller_email'] = 'cmqxwx@foxmail.com';  //卖家邮箱，必须填写
