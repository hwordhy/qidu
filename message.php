...
if (!empty($_POST["act"]) && in_array($_POST["act"], array("delete", "clear"))) {
	jieqi_checkpost();
	$where = "";
...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template($_REQUEST["box"] . ".html", "system");
...
case "inbox":
    ...
    if (isset($_REQUEST["ajax_gets"]) && JIEQI_COVER_DIR == '') {
        echo json_encode(array("success" => true, "data" => $messagerows, "message" => '获取成功'));
        return false;
    }
