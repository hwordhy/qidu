...
if ($do =='submit') {
    ...
    if ($action=='new') {
        ...
        if (file_exists($syncpath)) {
            ...
            $save = null;
            foreach ($syncsite as $k=>$v) {
                $save .='$syncsite['.$k.']='.var_export($v, true).';'.PHP_EOL;
            }
...
<tr valign="middle" align="left">
  ...
  <td class="tdr"><input type="text" class="text" name="siteurl" id="siteurl" size="60"  value="<?php echo $sync['siteurl']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">sid</td>
  <td class="tdr"><input type="text" class="text" name="sid" id="sid" size="60"  value="<?php echo $sync['sid']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">key</td>
  <td class="tdr"><input type="text" class="text" name="key" id="key" size="60"  value="<?php echo $sync['key']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">接口格式</td>
  <td class="tdr"><input type="text" class="text" name="format" id="format" size="60"  value="<?php echo $sync['format']?>" />(填json或xml)</td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">小说列表</td>
  <td class="tdr"><input type="text" class="text" name="alist" id="alist" size="60"  value="<?php echo $sync['alist']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">小说信息</td>
  <td class="tdr"><input type="text" class="text" name="ainfo" id="ainfo" size="60"  value="<?php echo $sync['ainfo']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">章节列表</td>
  <td class="tdr"><input type="text" class="text" name="clist" id="clist" size="60"  value="<?php echo $sync['clist']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">章节内容</td> 
  <td class="tdr"><input type="text" class="text" name="content" id="content" size="60" value="<?php echo $sync['content']?>" /></td>
</tr>
<tr valign="middle" align="left">
  <td class="tdl" width="25%">更新时间(时间格式的数字字符串，包含4位年、2位月、2位日、2位时、2位分、2位秒，比如：2014年11月6日8点30分，表示为：20141106083000)</td> 
  <td class="tdr"><input type="text" class="text" name="uptime" id="uptime" size="60"  value="<?php echo $sync['uptime']?>" /></td>
</tr>
