...
?>
  <tr>
    ...
    <td align="center"><a href="/modules/article/admin/newsynclog.php?id=<?php echo $k?>">查看</a></td>
    <td align="center"><a href="/modules/article/admin/newsyncedit.php?action=edit&id=<?php echo $k?>">编辑</a> | <a href="javascript:if(confirm('确实要删除该同步规则么？')) document.location='/modules/article/admin/newsyncedit.php?action=del&id=<?php echo $k?>'">删除</a> | <a href="/modules/article/admin/newsync.php?id=<?php echo $k?>">同步</a></td>
  </tr>
<?php
  }
?>
