...
$jieqiPayset['alipay']['payid'] = '2088631241347375';  //签约的支付宝账号唯一用户号（PID），以2088开头的16位纯数字组成（请输入实际申请的值）

$jieqiPayset['alipay']['paykey'] = '77o64x1hda9b9hyrsko2kkrigtequ70d';  //通讯密钥值（KEY）（请输入实际申请的值）
