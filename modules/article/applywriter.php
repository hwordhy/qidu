...
if ((isset($_POST["act"]) && ($_POST["act"] == "applywriter")) || (isset($_REQUEST["agree"]) && ($_REQUEST["agree"] == "1"))) {
	...
	if ($jieqiConfigs["article"]["checkappwriter"] == 1) {
        ...
        jieqi_jumppage(LANG_DO_SUCCESS, LANG_DO_SUCCESS, $jieqiLang["article"]["apply_submit_success"]);
        //jieqi_msgbox(LANG_DO_SUCCESS, $jieqiLang["article"]["apply_submit_success"]);
...
//		include_once jieqi_path_common("footer.php");
	...
	$jieqiTpl->setCaching(0);
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("applywriter.html", "article");
	include_once jieqi_path_common("footer.php");
}
