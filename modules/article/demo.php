...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("demo.html", "article");
...
$jieqiTpl->assign("qqgf", empty($jieqiConfigs["article"]["qqgf"]) ? '-' : $jieqiConfigs["article"]["qqgf"]);
$jieqiTpl->assign("dygf", empty($jieqiConfigs["article"]["dygf"]) ? '-' : $jieqiConfigs["article"]["dygf"]);
$jieqiTpl->assign("zyqdgf", empty($jieqiConfigs["article"]["zyqdgf"]) ? '-' : $jieqiConfigs["article"]["zyqdgf"]);
$jieqiTpl->assign("dsfqdgf", empty($jieqiConfigs["article"]["dsfqdgf"]) ? '-' : $jieqiConfigs["article"]["dsfqdgf"]);
$jieqiTpl->assign("bdgc", empty($jieqiConfigs["article"]["bdgc"]) ? '-' : $jieqiConfigs["article"]["bdgc"]);
$jieqiTpl->assign("mdgc", empty($jieqiConfigs["article"]["mdgc"]) ? '-' : $jieqiConfigs["article"]["mdgc"]);
