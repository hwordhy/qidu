...
case "buy":
	...
	if (empty($errtext)) {
        ...
        $users->saveToSession();
        jieqi_msgbox(LANG_DO_SUCCESS, sprintf($jieqiLang["article"]["monthly_buy_success"], date("Y-m-d", $overtime)));
	}
	else {
...
default:
	...
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("monthlybuy.html", "article");
