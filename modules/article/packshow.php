...
while ($chapter) {
	...
	if (strtolower(trim($tmpary["chaptertype"])) == 1) {
		...
		$opf_chapters[$i]["size_c"] = jieqi_sizeformat($opf_chapters[$i]["size"], "c");
		$opf_chapters[$i]["size_k"] = jieqi_sizeformat($opf_chapters[$i]["size"], "k");
		$opf_chapters[$i]["size_w"] = jieqi_sizeformat($opf_chapters[$i]["size"], "w");
		$i++;
		$opf_cnum++;
	}
...
case "zip":
	...
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("packzip.html", "article");
	break;
...
case "jad":
	...
	$jieqiTpl->assign_by_ref("packrows", $packrows);
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("packjar.html", "article");
	break;
...
case "umd":
	...
	$jieqiTpl->assign_by_ref("packrows", $packrows);
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("packumd.html", "article");
	break;
...
default:
	...
	$jieqiTset["jieqi_contents_template"] = jieqi_path_template("packtxtchapter.html", "article");
	break;
}
