...
if (is_numeric($jieqiConfigs["article"]["rateminsize"]) && ($article->getVar("size") < intval($jieqiConfigs["article"]["rateminsize"]))) {
	jieqi_printfail(sprintf($jieqiLang["article"]["rate_min_articlesize"], $jieqiConfigs["article"]["rateminsize"]));
}
