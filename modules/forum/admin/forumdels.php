...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("admin/forumdels.html", "forum");
...
if (isset($_POST["act"]) && ($_POST["act"] == 1) && is_array($_POST["checkid"]) && (0 < intval(jieqi_count($_POST["checkid"])))) {
	jieqi_checkpost();
	jieqi_includedb();
