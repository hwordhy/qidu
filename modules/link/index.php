...
if (!$jieqiTpl->is_cached(jieqi_path_template("linklist.html", "link"))) {
	include_once jieqi_path_inc("class/link.php", "link");
...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("linklist.html", "link");
