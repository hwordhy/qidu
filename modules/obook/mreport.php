...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("mreport.html", "obook");
...
$jieqiTpl->assign("qqgf", $uservals['qqgf']);
$jieqiTpl->assign("dygf", $uservals['dygf']);
$jieqiTpl->assign("zyqdgf", $uservals['zyqdgf']);
$jieqiTpl->assign("dsfqdgf", $uservals['dsfqdgf']);
$jieqiTpl->assign("bdgc", $uservals['bdgc']);
$jieqiTpl->assign("mdgc", $uservals['mdgc']);
...
$obookrows = array();
$k = 0;
include_once jieqi_path_inc("include/funobook.php", "obook");
