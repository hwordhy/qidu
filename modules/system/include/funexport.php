...
function jieqi_system_exportfile($params)
{
	...
	if ($format == 'exceltxt') {
		...
		$outputFileName = str_replace(".xls", ".txt", $params['filename']);
		...
		include_once jieqi_path_lib("excel/PHPExcel.php");

		if ($format == 'excel2007') {
			include_once jieqi_path_lib("excel/PHPExcel/Writer/Excel2007.php");
		}
		else {
			include_once jieqi_path_lib("excel/PHPExcel/Writer/Excel5.php");
		}
