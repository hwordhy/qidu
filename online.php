...
if (!JIEQI_USE_CACHE || !$jieqiTpl->is_cached(jieqi_path_template("online.html", JIEQI_MODULE_NAME))) {
	include_once jieqi_path_inc("class/online.php", JIEQI_MODULE_NAME);
...
$jieqiTset["jieqi_contents_template"] = jieqi_path_template("online.html", JIEQI_MODULE_NAME);
