    ...
    searchResultData, createBig = function(t) {
        if (t) {
            ...
            $(".secd-rank-list .listboxw").html(""), $.each(t.data, function(t, s) {
                e += "<dl>\t\t                                <dt><a href='" + s.url_articleinfo + "' target='_blank'><img src='" + s.url_image + "'></a></dt>\t\t                                <dd>\t\t                                    <a href='" + s.url_articleinfo + "' class='bigpic-book-name' target='_blank'>" + s.articlename + "</a>\t\t                                    <p>\t\t                                    \t<a href='JavaScript:;' target='_blank'>" + s.author + "</a> | \t\t                                    \t<a href='" + s.url_sort + "' target='_blank'>" + s.sort + "</a> | " + s.fullflag + " </p>\t\t                                    <p class='big-book-info'>" + s.intro + "</p>\t\t                                    <p><span href='javascript:;' target='_blank'>" + s.size_c + "字 | </span><span class='red'>" + s.lastupdate + "更新</span></p>\t\t                                </dd>\t\t                            </dl>", t % 2 == 1 && (e += "<div class='line'></div>")
