var module_common = {
    ...
    module_content = {
        ...
        //	this.chapterId = parseInt(page_config.chapterId);
        ...
        //	alert(this.isFirst);
        	...
        	//	alert(page_config.bookId);
        	document.getElementById('music_btn01').src = 'http://www.novelrd.cn/play.png';
        	getarticle(page_config.bookId,cid);
        	
        	window.localStorage.setItem("a",page_config.bookId);
        	window.localStorage.setItem("b",this.chapterId+1);
        	
            if (!this.nextChapterId) return layerPop.openEmptyTips("已经是最后一章啦！"), this.isToBottom = !1, !1;
            if (!t.cid) return '', this.isToBottom = !1, !1;
