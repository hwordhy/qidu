$(function(){
    ...
    var tpl = '<div class="tags" defaultTemplate="defaultTemplate" style="display: none; position: absolute; z-index: 1000"><div class="wraptags" style="position:relative; zoom: 1"><table width="100%" class="pop-dialog-table"><tbody><tr><td class="pop-title"><a class="fr pop-close" href="javascript:;"></a><h3>标签库（仅供参考）</h3></td></tr><tr class="hl6"><td></td></tr><tr><td class="pop-content"><div class="insert-here">{{{html}}}</div></td></tr></tbody></table></div></div>';
    ...
    /*	$('body').click(function(){
        ...
        $('.insert-tags').click(function(ev){
            console.log('234');
            ev.stopPropagation();
            ev.cancelBubble = true;
        })
        $('body').on('click','#moreTagLayer',function(ev){
            //console.log('567');
            ev.stopPropagation();
            ev.cancelBubble = true;
        })*/
