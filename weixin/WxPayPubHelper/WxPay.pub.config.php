...
class WxPayConf_pub
{
	...
	const APPID = 'wxdb275743ae7d12df';
	//受理商ID，身份标�?
	const MCHID = '1539554881';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查�?
	const KEY = 'dfasdsmpowfeldfaDFASDF122dfewqrf';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查�?
	const APPSECRET = '495461772ee2b941fa209a4774baee8c';
	
	//=======【JSAPI路径设置�?==================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	const JS_API_CALL_URL = 'http://www.novelrd.cn/weixin/pay.php';
	...
	//=======【异步通知url设置�?==================================
	//异步通知url，商户根据实际开发过程设�?
	const NOTIFY_URL = 'http://www.novelrd.cn/weixin/notify_url.php';
